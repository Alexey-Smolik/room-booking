...
var getRoom = exports.getRoom = function getRoom(roomID) {
...
var deleteEvent = exports.deleteEvent = function deleteEvent(eventID) {
    return async function (dispatch) {
        var res = await _axios2.default.delete('/api/events', eventID);
        dispatch({ type: _types.DELETE_EVENT, payload: res.data });
    };
};

var editEvent = exports.editEvent = function editEvent(eventID, editedEvent) {
    return async function (dispatch) {
        var res = await _axios2.default.put('/api/events', eventID, editedEvent);
        dispatch({ type: _types.EDIT_EVENT, payload: res.data });
    };
};
...
var GET_ROOM = exports.GET_ROOM = 'get-room';
var GET_ROOMS = exports.GET_ROOMS = 'get-rooms';
...
var _react_jqxscheduler = __webpack_require__(23);

var _react_jqxscheduler2 = _interopRequireDefault(_react_jqxscheduler);
...
var Table = function (_React$Component) {
    ...
    _createClass(Table, [{
        ...
        value: function render() {
            ...
            var source = {
                dataType: "array",
                dataFields: [{ name: 'id', type: 'string' }, { name: 'description', type: 'string' }, { name: 'location', type: 'string' }, { name: 'subject', type: 'string' }, { name: 'calendar', type: 'string' }, { name: 'start', type: 'date' }, { name: 'end', type: 'date' }],
                id: 'id',
...
var store = (0, _redux.createStore)(_index2.default, {} /*actions.getRooms()*/, (0, _redux.applyMiddleware)(_reduxThunk2.default));
...
var m=__webpack_require__(24),n=__webpack_require__(25),p=__webpack_require__(9),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(54),B=__webpack_require__(24),C=__webpack_require__(9),ba=__webpack_require__(55),da=__webpack_require__(56),ea=__webpack_require__(57),fa=__webpack_require__(58),ia=__webpack_require__(61),D=__webpack_require__(25);
...
var _LeftNavBar = __webpack_require__(134);

var _LeftNavBar2 = _interopRequireDefault(_LeftNavBar);

var _BookTable2 = __webpack_require__(135);

var _BookTable3 = _interopRequireDefault(_BookTable2);

var _bookFrame = __webpack_require__(136);

var _bookFrame2 = _interopRequireDefault(_bookFrame);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(38), __webpack_require__(105)(module)))
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "form",
                        { className: "hello", name: "search", action: "#", method: "get" },
                        _react2.default.createElement(
                            "label",
                            { id: "username" },
                            "HELLO,"
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            "p",
                            { className: "text" },
                            "\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0434\u043B\u044F \u0412\u0430\u0441 \u043F\u043E\u0434\u0445\u043E\u0434\u044F\u0449\u0438\u0439 \u043E\u0444\u0438\u0441 \u0438\u043B\u0438 \u0440\u043E\u0441\u043A\u043E\u0448\u043D\u0443\u044E \u043A\u043E\u043C\u043D\u0430\u0442\u0443!"
                        )
                    )
                )
            );
...
var LeftNavBar = function (_Component) {
    _inherits(LeftNavBar, _Component);

    function LeftNavBar() {
        _classCallCheck(this, LeftNavBar);

        return _possibleConstructorReturn(this, (LeftNavBar.__proto__ || Object.getPrototypeOf(LeftNavBar)).apply(this, arguments));
    }
...
var BookTable = function (_React$Component) {
    ...
    function BookTable() {
        ...
        return _possibleConstructorReturn(this, (BookTable.__proto__ || Object.getPrototypeOf(BookTable)).apply(this, arguments));
    }
    ...
    _createClass(BookTable, [{
        ...
        value: function componentWillMount() {
            console.log("BookTable -> componentWillMount");
        }
    }, {
        key: 'componentWillUnmount',
        value: function componentWillUnmount() {
            console.log("BookTable -> componentWillUnmount");
        }
    }, {
        ...
        key: 'renderTable',
        value: function renderTable(appointments) {
            var source = {
                dataType: "array",
                dataFields: [{ name: 'id', type: 'string' }, { name: 'description', type: 'string' }, { name: 'location', type: 'string' }, { name: 'subject', type: 'string' }, { name: 'calendar', type: 'string' }, { name: 'start', type: 'date' }, { name: 'end', type: 'date' }],
                id: 'id',
...
var bookFrame = function (_React$Component) {
    _inherits(bookFrame, _React$Component);

    function bookFrame() {
        _classCallCheck(this, bookFrame);

        return _possibleConstructorReturn(this, (bookFrame.__proto__ || Object.getPrototypeOf(bookFrame)).apply(this, arguments));
    }

    _createClass(bookFrame, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
...
var _roomsList = __webpack_require__(138);

var _roomsList2 = _interopRequireDefault(_roomsList);

var _roomEvents = __webpack_require__(139);

var _roomEvents2 = _interopRequireDefault(_roomEvents);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = (0, _redux.combineReducers)({
    rooms: _roomsList2.default,
    events: _roomEvents2.default
});
...
exports.default = function () {
    ...
    switch (action.type) {
        case _types.GET_ROOM:
            return action.payload || false;

        case _types.DELETE_EVENT:
            return action.payload || false;

        case _types.CREATE_EVENT:
            return action.payload || false;
